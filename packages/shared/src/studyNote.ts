 ...
 * note is added to and removed from a list and this is one field always on screen.
 *
 * One difference in the rules themselves: a blank note normalises to the empty string rather than
 * to null, because `StudyPlanRecord.comment` is never null and an emptied note is a legitimate edit
