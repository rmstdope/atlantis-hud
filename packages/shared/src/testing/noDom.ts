...
export const NO_DOM_GUIDANCE = [
  ...
  "`workspace/dossierPeek.ts` is the worked example - the rule is a plain function, and",
  "`workspace/FactionDossierPanel.tsx` is the thin component that measures the browser and calls",
  "it. The smoke suite is where anything needing a real browser is checked.",
  "",
