...
export const UnitTableDock = forwardRef<UnitTableDockHandle, UnitTableDockProps>(
   ...
   * guarantees the table cannot drift from the order `AppShell` picks defaults from. The orders preview folds in on top, so everything below it - filter and sort - already
