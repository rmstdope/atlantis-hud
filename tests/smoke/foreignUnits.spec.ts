...
test("choosing Other factions lists units of other factions", async ({ page }) => {
  ...
  // The Hex column comes with it, exactly as it does for All my units - thirteen columns.
  await expect(page.getByTestId("panel-units").locator("thead th")).toHaveCount(13);
