...
| `neworigins-3.0.0-g3-f42-t42.rep` | 3 | 42 | 42 | 5.2.4 | multi-step accumulated route: the current turn, 3 of 3 - a route only the accumulated map can find (`movement/plan/memory.rs`, `workspace.spec.ts`) |
